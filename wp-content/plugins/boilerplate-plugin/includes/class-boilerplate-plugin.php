 ...
 * @package    Boilerplate_Plugin
 * @subpackage Boilerplate_Plugin/includes
 * @author     Applied Research & Consulting <sjuane@arclabs.ca>
 */
class Boilerplate_Plugin {
	...
	public function __construct() {
		...
		$this->plugin_name = 'boilerplate-plugin';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-boilerplate-plugin-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-boilerplate-plugin-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-boilerplate-plugin-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-boilerplate-plugin-public.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Boilerplate_Plugin_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Boilerplate_Plugin_Public( $this->get_plugin_name(), $this->get_version() );
